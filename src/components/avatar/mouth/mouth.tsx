...
import { MouthStyle, PartConfig } from "../sentry-avatar.types";
...
function Mouth({ width, height, config: { style, color } }: MouthProps) {
  switch (style) {
            ...
            <g id="Mouth">
              <g id="Mouth_1">
                <path
                  ...
                  fill={darkenHexColor(color, MOUTH_DARKENED_PERCENTAGE)}
